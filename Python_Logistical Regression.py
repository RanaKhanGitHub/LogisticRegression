...
dataset1['Class'].value_counts().plot.bar(figsize=(10,4),title='Classes Split for Dataset1')
plt.xlabel('Classes')
plt.ylabel('Count')
...
x2 = dataset1.drop('Class', axis=1).values
...
feature_name = dataset1.drop('Class',axis=1).columns[feature_idx]
